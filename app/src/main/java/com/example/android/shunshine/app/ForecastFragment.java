...
/**
 * Created by Arizal on 4/11/2015.
    ...
    class fetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                final String log_salah= this.getClass().getSimpleName();// buat di masukin ke log ketika ada eroor sehingga mudah buat melihat mana yang salah
                Log.v(log_salah, url.toString());
                ...
                Log.v(log_salah,forecastJsonStr);
